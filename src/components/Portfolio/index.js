        ...
        <section className="portfolio-section">
            ...
            <Carousel responsive={responsive} swipeable={true}>
                <div className="relative m-2 group group/edit transition ease-in-out delay-200 hover:translate-y-1 hover:scale-90 duration-300">
                    <img src={mealMaker} className='m-2 rounded-3xl shadow-lg transition ease-linear delay-100 group-hover:opacity-10 duration-300 bg-[#212359]' style={{ width: '100%', height: '320px'}} alt='cover'/>
                ...
                <div className="relative group group/edit transition ease-in-out delay-200 bg-[#212359] rounded-3xl m-2 text-lg flex flex-col justify-center text-center group-hover:opacity-10 duration-300 hover:translate-y-1 hover:scale-90" style={{ width: '100%', height: '320px'}}>
                        ...
                        <div className="absolute top-1 xl:text-7xl text-5xl invisible">
                ...
                <div className="relative m-2 group group/edit transition ease-in-out delay-200 hover:translate-y-1 hover:scale-90 duration-300">
                    <img src={tikTak} className='m-2 rounded-3xl shadow-lg group-hover:opacity-10 bg-[#212359]' style={{ width: '100%', height: '320px'}} alt='cover'/>
                ...
                <div className="relative m-2 group group/edit transition ease-in-out delay-200 hover:translate-y-1 hover:scale-90 duration-300">
                    <img src={ourplace} className='m-2 rounded-3xl shadow-lg group-hover:opacity-10 bg-[#212359]' style={{ width: '100%', height: '320px'}} alt='cover'/>
                    <div className="absolute left-0 top-24 right-0 text-center invisible">
                ...
                <div className="relative m-2 group group/edit transition ease-in-out delay-200 hover:translate-y-1 hover:scale-90 duration-300">
                    <img src={techBlog} className='m-2 rounded-3xl shadow-lg group-hover:opacity-10 bg-[#212359]' style={{ width: '100%', height: '320px'}} alt='cover'/>
                    <div className="absolute left-0 top-24 right-0 text-center invisible">
                    ...
                    <div className="absolute top-1 left-2 xl:text-7xl text-5xl invisible">
                ...
                <div className="relative m-2 group group/edit transition ease-in-out delay-200 hover:translate-y-1 hover:scale-90 duration-300">
                    <img src={Jate} className='m-2 rounded-3xl shadow-lg group-hover:opacity-10 bg-[#212359]' style={{ width: '100%', height: '320px'}} alt='cover'/>
                    <div className="absolute left-0 top-24 right-0 text-center invisible">
