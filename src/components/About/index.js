...
const About = () => {
    return(
        <section className="my-4 flex flex-wrap justify-center text-center p-5 font-serif selection:bg-indigo-400 selection:text-teal-200">
            ...
            <div className="text-7xl flex justify-center"style={{width: '100%'}}>
                <a className="text-purple-600 hover:animate-bounce hover:text-teal-400" href="https://www.linkedin.com/in/david-dowell95/" target="_blank" rel="noreferrer">
                <AiFillLinkedin></AiFillLinkedin>
                </a>
                <a className="text-purple-600 hover:animate-bounce hover:text-teal-400" href="https://github.com/DavidDowell" target="_blank" rel="noreferrer">
